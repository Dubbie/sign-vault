  ...
  >
    <div class="flex items-center justify-between gap-4">
      <p class="text-xs text-zinc-400">
        This site stores a token in your browser's local storage to keep you signed in. We don't use
        advertising cookies — only cookieless Cloudflare Web Analytics and hashed, non-identifying
        usage stats.
